...
const ca = fs_1.readFileSync(path_1.join(__dirname, 'fixtures', 'ca.pem'));
const key = fs_1.readFileSync(path_1.join(__dirname, 'fixtures', 'server1.key'));
const cert = fs_1.readFileSync(path_1.join(__dirname, 'fixtures', 'server1.pem'));
